...
const HomePage = () => {
  ...
  //     (localStorage.getItem("userInfo") ) || demoJson
  //   );
  ...
  return (
    <App>
      <div className="container mx-auto">
        <div className="flex justify-center p-3 bg-black w-full mt-10 mb-4 rounded-lg border">
          <h1 className="text-4xl font-work-sans text-white font-semibold">
            Message
          </h1>
        </div>
        <div className="bg-black w-full p-4 rounded-lg border">
          <div data-theme="dark" className="tabs tabs-box">
            <input
              type="radio"
              name="my_tabs_6"
